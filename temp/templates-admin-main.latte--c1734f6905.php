...
<body>
';
		$this->createTemplate('./components/topbar.latte', $this->params, 'include')->renderToContentType('html') /* line 24 */;
		$this->createTemplate('./components/sidebar.latte', $this->params, 'include')->renderToContentType('html') /* line 25 */;
		echo '
    <div class=\'page\'>
';
